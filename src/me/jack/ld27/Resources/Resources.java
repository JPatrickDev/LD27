...
public class Resources {
    ...
    private static void populateSounds() throws SlickException {
        addSoundResource("/res/sound/land.wav", "land");
        addSoundResource("/res/sound/pickup.wav", "pickup");
        addSoundResource("/res/sound/death.wav","death");
    }
